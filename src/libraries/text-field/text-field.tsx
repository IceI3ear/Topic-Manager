...
export const TextField = forwardRef(
  (props: TextFieldProps, ref: Ref<RefObject>) => {
    ...
    const onFocusInput = () => {
      setBorderInputColor(colors.focus);
    };
      ...
      <View style={[styles.container, containerStyle]}>
        ...
        <View
          style={[
            ...
            {borderColor: errorInput ? '#FF4D54' : borderInputColor},
          ]}>
          <View style={[styles.wrapInput]}>
            <TextInput
              autoCapitalize="none"
              defaultValue={value}
              placeholderTextColor={placeHolderColor || colors.gray_btn}
              {...props}
